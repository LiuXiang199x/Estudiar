...
class EndCond:
	...
	def MapsCb(self, globalmapCb):
		...
		if self.__getgoal:
			...
			frontier_map = np.full((self.__height_total, self.__width_total), 0, dtype=int)
			...
			#self.frontiermsg.frontier_map = tmp_frontier
			#self.__frontier_pub.publish(self.frontiermsg)
