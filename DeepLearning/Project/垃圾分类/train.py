from datasets.datasets import Garbage_Loader
...
if __name__ == "__main__":
    # -------------------------------------------- step 1/4 : 加载数据 ---------------------------
    dataset_dir = "/home/agent/Estudiar/DeepLearning/Project/垃圾分类/datasets"
    train_dir_list = os.path.join(dataset_dir, 'train.txt')
    valid_dir_list = os.path.join(dataset_dir, 'val.txt')
    ...
    model.load_state_dict(torch.load("/home/agent/pth_net/resnet50-19c8e357.pth"))
    
    # download and reload with url
    ...
    writer = SummaryWriter('/home/agent/Estudiar/DeepLearning/Project/垃圾分类/runs/resnet50')
