...
# 我们将网络输出的一维1470数据reshape成7×7×30的数据格式，
# 并且，根据上文Dataset类的实现可知，提取出的label(样本标签)也是7×7×30。
# 但是有一点要注意，label数据经过pytorch的toTensor()函数转换后，
# 数据会变成batchsize×30×7×7，所以网络的输出也应当对应改成batchsize×30×7×7
