...
class counterActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = counterGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new counterActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = counterGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new counterGoal()
    }
...
module.exports = counterActionGoal;
