...
class counterActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new counterFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = counterFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new counterActionFeedback(null);
    ...
    data.feedback = counterFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new counterActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = counterFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new counterFeedback()
    }
...
module.exports = counterActionFeedback;
