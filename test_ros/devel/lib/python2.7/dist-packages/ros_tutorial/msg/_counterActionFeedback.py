...
"""autogenerated by genpy from ros_tutorial/counterActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class counterActionFeedback(genpy.Message):
  _md5sum = "7b891b7efb3bad6f70675492440f5eb3"
  _type = "ros_tutorial/counterActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','ros_tutorial/counterFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(counterActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = ros_tutorial.msg.counterFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = ros_tutorial.msg.counterFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.feedback.complete_percent
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.feedback.complete_percent,) = _get_struct_f().unpack(str[start:end])
      return self
