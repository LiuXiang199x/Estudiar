...
vector<vector<vector<double>>> processTarget(vector<vector<double>> map_data, int idx, int idy) {
	...
	static vector<vector<double>> Ocp_crop(240, vector<double>(240,0));
	static vector<vector<double>> Expp_crop(240, vector<double>(240,0));
	static vector<vector<double>> Agentp_crop(240, vector<double>(240,0));
	static vector<vector<double>> Frontier_crop(240, vector<double>(240,0));
