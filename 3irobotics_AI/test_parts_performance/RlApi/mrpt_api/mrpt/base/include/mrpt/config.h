...
/** Tell Eigen libray to include MRPT's plugin for mrpt_Eigen::MatrixBase
  */
...
// Version as text:
#define MRPT_OPENCV_VERSION      "2.3.1"

// Version as hexadecimal number: eg. 1.0.0 -> 0x100
#define MRPT_OPENCV_VERSION_NUM  0x231
...
/*#if defined WIN32 && (!defined WIN64 || defined EM64T) && \
 (_MSC_VER >= 1500) || (defined __SSE4__ && defined __GNUC__ && __GNUC__ >= 4)
	#define MRPT_HAS_SSE4  1   // This value can be set to 0 from CMake with DISABLE_SSE4
#else
...
#define MRPT_HAS_ARIA 0

/** Whether to include the xSens MTi device interface: */
#define MRPT_HAS_xSENS_MT3 0
...
#ifndef HAVE_TIMEGM
/* #define HAVE_TIMEGM */
#undef HAVE_TIMEGM	//add by bruce
#endif
...
#ifndef HAVE_GETTID
/* #undef HAVE_GETTID */
#define HAVE_GETTID	//add by bruce
#endif
...
#undef HAVE_POSIX_MEMALIGN	//add by bruce
#endif
