...
#ifndef EIGEN_MRPT_MAP_H
#define EIGEN_MRPT_MAP_H
...
{
  this->_set_noalias(mrpt_Eigen::Map<const Array>(data));
}
...
{
  this->_set_noalias(mrpt_Eigen::Map<const Matrix>(data));
}

} // end namespace mrpt_Eigen

#endif // EIGEN_MRPT_MAP_H
