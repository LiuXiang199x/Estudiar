...
#ifndef EIGEN_MRPT_MATRIXBASE_H
#define EIGEN_MRPT_MATRIXBASE_H
...
#define EIGEN_CURRENT_STORAGE_BASE_CLASS mrpt_Eigen::MatrixBase
...
#undef EIGEN_CURRENT_STORAGE_BASE_CLASS
    ...
    NoAlias<Derived,mrpt_Eigen::MatrixBase > noalias();
