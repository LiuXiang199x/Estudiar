...
#ifndef EIGEN_MRPT_SELFADJOINTEIGENSOLVER_H
#define EIGEN_MRPT_SELFADJOINTEIGENSOLVER_H
...
template<typename SolverType> struct direct_selfadjoint_eigenvalues<SolverType,3,false>
{
  ...
  static inline void run(SolverType& solver, const MatrixType& mat, int options)
  {
    ...
    if(computeEigenvectors)
    {
      Scalar safeNorm2 = mrpt_Eigen::NumTraits<Scalar>::epsilon();
      safeNorm2 *= safeNorm2;
      if((eivals(2)-eivals(0))<=mrpt_Eigen::NumTraits<Scalar>::epsilon())
      {
        eivecs.setIdentity();
      }
      else
      {
        ...
        if(d0<=mrpt_Eigen::NumTraits<Scalar>::epsilon())
...
#endif // EIGEN_MRPT_SELFADJOINTEIGENSOLVER_H
