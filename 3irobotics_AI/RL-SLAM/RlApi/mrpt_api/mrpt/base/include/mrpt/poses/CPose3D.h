	...
	protected:
	 ...
	 public:
		...
		*/
		...
		static void jacob_dexpeD_de(const CPose3D &D, mrpt_Eigen::Matrix<double,12,6> & jacob);
		...
		static void jacob_dAexpeD_de(const CPose3D &A, const CPose3D &D, mrpt_Eigen::Matrix<double,12,6> & jacob);
