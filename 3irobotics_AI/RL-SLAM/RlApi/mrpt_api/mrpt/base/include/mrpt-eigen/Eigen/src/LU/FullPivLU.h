...
#ifndef EIGEN_MRPT_LU_H
#define EIGEN_MRPT_LU_H
...
{
  EIGEN_MRPT_MAKE_KERNEL_HELPERS(FullPivLU<_MatrixType>)
...
{
  EIGEN_MRPT_MAKE_IMAGE_HELPERS(FullPivLU<_MatrixType>)
...
{
  EIGEN_MRPT_MAKE_SOLVE_HELPERS(FullPivLU<_MatrixType>,Rhs)
