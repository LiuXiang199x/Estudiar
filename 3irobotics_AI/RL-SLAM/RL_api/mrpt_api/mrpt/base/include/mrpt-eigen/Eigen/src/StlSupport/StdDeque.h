...
#ifndef EIGEN_MRPT_STDDEQUE_H
#define EIGEN_MRPT_STDDEQUE_H
...
#define EIGEN_STD_DEQUE_SPECIALIZATION_BODY \
  ...
  template<typename T>
  class deque<T,EIGEN_MRPT_ALIGNED_ALLOCATOR<T> >
                   ...
                   mrpt_Eigen::aligned_allocator_indirection<EIGEN_WORKAROUND_MSVC_STL_SUPPORT(T)> >
{
  typedef deque<EIGEN_WORKAROUND_MSVC_STL_SUPPORT(T),
                mrpt_Eigen::aligned_allocator_indirection<EIGEN_WORKAROUND_MSVC_STL_SUPPORT(T)> > deque_base;
