...
namespace mrpt
{
	namespace math
	{
		 ...
		 *   Basically, this class is a wrapper on mrpt_Eigen::Matrix<T,NROWS,NCOLS>, but
		...
		class CMatrixFixedNumeric  :
			public mrpt_Eigen::Matrix<
				...
				mrpt_Eigen::AutoAlign |
				( (NCOLS==1 && NROWS!=1) ? mrpt_Eigen::ColMajor : mrpt_Eigen::RowMajor )
				>
		{
		public:
			typedef mrpt_Eigen::Matrix<T,NROWS,NCOLS, mrpt_Eigen::AutoAlign | ( (NCOLS==1 && NROWS!=1) ? mrpt_Eigen::ColMajor : mrpt_Eigen::RowMajor ) > Base;
