...
#ifndef EIGEN_MRPT_XPRHELPER_H
#define EIGEN_MRPT_XPRHELPER_H
...
template<typename T, int Value> class variable_if_dynamic
{
  public:
    ...
    void printfInfor() {printf("*************** Debug 3 Debug *****************");}
};
...
template<typename T> class variable_if_dynamic<T, Dynamic>
{
  ...
  public:
    ...
    void printfInfor() {printf("*************** Debug 4 Debug *****************");}
};
