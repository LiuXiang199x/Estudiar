...
#ifndef EIGEN_MRPT_SUPERLUSUPPORT_H
#define EIGEN_MRPT_SUPERLUSUPPORT_H
...
#ifdef MILU_ALPHA
#define EIGEN_MRPT_SUPERLU_HAS_ILU
#endif

#ifdef EIGEN_MRPT_SUPERLU_HAS_ILU
  ...
  : solve_retval_base<SuperLUBase<_MatrixType,Derived>, Rhs>
{
  ...
  EIGEN_MRPT_MAKE_SOLVE_HELPERS(Dec,Rhs)
...
{
  typedef SuperLUBase<_MatrixType,Derived> Dec;
  EIGEN_MRPT_MAKE_SPARSE_SOLVE_HELPERS(Dec,Rhs)
...
#endif // EIGEN_MRPT_SUPERLUSUPPORT_H
