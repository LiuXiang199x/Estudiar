...
#ifndef EIGEN_MRPT_SPARSELU_GEMM_KERNEL_H
#define EIGEN_MRPT_SPARSELU_GEMM_KERNEL_H
...
{
  using namespace mrpt_Eigen::internal;
...
#endif // EIGEN_MRPT_SPARSELU_GEMM_KERNEL_H
