...
#ifndef EIGEN_MRPT_SPARSE_SOLVE_H
#define EIGEN_MRPT_SPARSE_SOLVE_H
...
#define EIGEN_MRPT_MAKE_SPARSE_SOLVE_HELPERS(DecompositionType,Rhs) \
  typedef typename DecompositionType::MatrixType MatrixType; \
...
#endif // EIGEN_MRPT_SPARSE_SOLVE_H
