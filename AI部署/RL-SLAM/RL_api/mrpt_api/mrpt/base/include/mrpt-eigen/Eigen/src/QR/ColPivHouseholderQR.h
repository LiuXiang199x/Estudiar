...
#ifndef EIGEN_MRPT_COLPIVOTINGHOUSEHOLDERQR_H
#define EIGEN_MRPT_COLPIVOTINGHOUSEHOLDERQR_H
...
{
  EIGEN_MRPT_MAKE_SOLVE_HELPERS(ColPivHouseholderQR<_MatrixType>,Rhs)
...
#endif // EIGEN_MRPT_COLPIVOTINGHOUSEHOLDERQR_H
