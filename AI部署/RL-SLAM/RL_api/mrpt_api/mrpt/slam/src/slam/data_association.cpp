	...
	)
{
	...
	// ----------------------------------------------------------------------
	mrpt_Eigen::Matrix<T,mrpt_Eigen::Dynamic,mrpt_Eigen::Dynamic> COV;
	...
	// ----------------------------------------------------------------------
	mrpt_Eigen::Matrix<T,mrpt_Eigen::Dynamic,1>  innovations(N * info.length_O);
	...
	)
{
	...
	mrpt_Eigen::VectorXd  diff_means_i_j(length_O);
