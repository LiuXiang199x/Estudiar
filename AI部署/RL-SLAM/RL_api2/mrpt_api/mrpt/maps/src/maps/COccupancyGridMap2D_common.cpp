...
/*---------------------------------------------------------------
						clearMapCache
  ---------------------------------------------------------------*/
void COccupancyGridMap2D::clearMapCache()
{	
	std::vector<cellType> temp_map;
	temp_map.swap(map);
	map.clear();
...
/*---------------------------------------------------------------
							subSample
 ---------------------------------------------------------------*/
void  COccupancyGridMap2D::subSample( int downRatio , float obstacle_value)
{
	...
	for (int x=0;x<newSizeX;x++)
	{
		for (int y=0;y<newSizeY;y++)
		{
            ...
            if(minCell <= obstacle_value)
            {
                newMap[ x + y*newSizeX ] = p2l(0);
            }
            else
            {
                newMap[ x + y*newSizeX ] = p2l(0.9);
            }
		}
	}
	...
	map.clear();
	this->resolution = resolution;
	this->size_x = newSizeX;
	this->size_y = newSizeY;

	// Cells memory:
	map.resize(size_x*size_y, p2l(0.5f));
	map = newMap;
}
...
/*---------------------------------------------------------------
							sampleBymin
 ---------------------------------------------------------------*/
void  COccupancyGridMap2D::sampleBymin( int downRatio )
{
	std::vector<cellType>		newMap;
...
/*---------------------------------------------------------------
							sample
 ---------------------------------------------------------------*/
void  COccupancyGridMap2D::sample( int downRatio )
{
	std::vector<cellType>		newMap;
