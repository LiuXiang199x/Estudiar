...
#ifndef EIGEN_MRPT_MATRIXSTORAGE_H
#define EIGEN_MRPT_MATRIXSTORAGE_H
...
struct plain_array<T, Size, MatrixOrArrayOptions, 16>
{
  ...
  plain_array() 
  { 
    //EIGEN_MAKE_UNALIGNED_ARRAY_ASSERT(0xf);  //notes by huanglianglin
    EIGEN_STATIC_ASSERT(Size * sizeof(T) <= 128 * 128 * 8, OBJECT_ALLOCATED_ON_STACK_IS_TOO_BIG);
  }
