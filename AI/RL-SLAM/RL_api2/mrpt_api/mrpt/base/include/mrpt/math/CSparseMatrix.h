	...
	namespace math
	{
		...
		public:
			...
			public:
				...
				/** Return the vector from a back-substitution step that solves: Ux=b. Vectors can be mrpt_Eigen::VectorXd or mrpt::math::CVectorDouble   */
				void backsub(const mrpt_Eigen::VectorXd &b, mrpt_Eigen::VectorXd &result_x) const;
