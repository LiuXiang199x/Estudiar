...
void mrpt::math::ransac_detect_3D_planes(
	const mrpt_Eigen::Matrix<NUMTYPE,mrpt_Eigen::Dynamic,1>  &x,
	const mrpt_Eigen::Matrix<NUMTYPE,mrpt_Eigen::Dynamic,1>  &y,
	const mrpt_Eigen::Matrix<NUMTYPE,mrpt_Eigen::Dynamic,1>  &z,
...
#define EXPLICIT_INST_ransac_detect_3D_planes(_TYPE_) \
	...
	const mrpt_Eigen::Matrix<_TYPE_,mrpt_Eigen::Dynamic,1>  &x, \
	const mrpt_Eigen::Matrix<_TYPE_,mrpt_Eigen::Dynamic,1>  &y, \
	const mrpt_Eigen::Matrix<_TYPE_,mrpt_Eigen::Dynamic,1>  &z, \
	vector<pair<size_t,TPlane> >   &out_detected_planes, \
	const double           threshold, \
	const size_t           min_inliers_for_valid_plane);
