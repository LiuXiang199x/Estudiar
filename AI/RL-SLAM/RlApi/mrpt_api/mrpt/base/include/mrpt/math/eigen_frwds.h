...
#include <mrpt-eigen/Eigen/src/Core/util/DisableStupidWarnings.h>
#include <mrpt-eigen/Eigen/src/Core/util/Macros.h>
#include <complex> // Needed by hdrs below

#define STAGE99_NO_EIGEN2_SUPPORT           99
#define EIGEN2_SUPPORT_STAGE STAGE99_NO_EIGEN2_SUPPORT

#if !EIGEN_MRPT_VERSION_AT_LEAST(3,0,93)
namespace MrptEigen {
#endif
// These headers were assumed to lie inside namespace Eigen{} in Eigen <=3.1.0
#	include <mrpt-eigen/Eigen/src/Core/util/Constants.h>
#	include <mrpt-eigen/Eigen/src/Core/util/ForwardDeclarations.h>
...
namespace mrpt
{
    namespace math
    {
    	...
    	struct ContainerType<mrpt_Eigen::EigenBase<Derived> > {
