...
namespace mrpt
{
	namespace hwdrivers
	{
		...
		public:
			...
			virtual bool initialize();  //!< Attempts to connect and turns the laser on. Raises an exception on error.

			void symmetryLidarData(mrpt::slam::CObservation2DRangeScan	&outObservation);
