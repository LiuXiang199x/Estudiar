...
/*---------------------------------------------------------------
					getContent
 ---------------------------------------------------------------*/
void CConfigFile::getContent( std::string &str ) const
{
...
/*---------------------------------------------------------------
					setContent
 ---------------------------------------------------------------*/
void CConfigFile::setContent(  const utils::CStringList &stringList  )
{
    m_modified = true;
    // Load the strings:
    std::string aux;
...
/*---------------------------------------------------------------
					setContent
 ---------------------------------------------------------------*/
void CConfigFile::setContent(  const std::string &str )
{
    m_modified = true;
