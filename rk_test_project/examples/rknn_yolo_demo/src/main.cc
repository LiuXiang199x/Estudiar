...
int main(int argc, char** argv)
{
    ...
    long startt = start_time.tv_sec*1000 + start_time.tv_usec/1000;
    // Load image
    ...
    long end_load_model = end_load_model_time.tv_sec*1000 + end_load_model_time.tv_usec/1000;
    printf("end load model time:%ldms\n",end_load_model);
    ret = rknn_init(&ctx, model, model_len, 0);
    gettimeofday(&end_init_time, nullptr);
    // end_load_model_time = GetTickCount();
    long end_init = end_init_time.tv_sec*1000 + end_init_time.tv_usec/1000;
    ...
    long stop = stop_time.tv_sec*1000 + stop_time.tv_usec/1000;
